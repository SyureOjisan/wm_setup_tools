...
class SAMKAbstractSetUp(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        self.report({'WARNING'}, f'WM Setup Tools: Setup error occured. :\'{self.error_code}\'')
        print(f'Operator \'{self.bl_idname}\' is executed')
        logger.warning(f'Setup error occured. operator : {self.bl_idname}')
    ...
    def invoke(self, context, event):
        ...
        try:
            ...
            self.error_code = 'No error occured.'
            self.can_setup = True
...
class SAMK_OT_Translate(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        try:
            ...
            logger.warning(f'Translation error occured. operator : {self.bl_idname}')
...
class SAMK_OT_FeedBack(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        try:
            ...
            self.report({'WARNING'}, f'WM Setup Tools: Object structure error occurred. :\'{e}\'')
            print(f'Operator \'{self.bl_idname}\' is aborted')
            logger.warning(f'Feedback error occured. operator : {self.bl_idname}')
...
class ReadProfile(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        try:
            ...
            logger.warning(f'Read file error occured. operator : {self.__class__.__name__}')
            return {'FINISHED'}
